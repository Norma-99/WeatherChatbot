...
class MyCustomAction(Action):
    ...
    async def run(
        ...
        # dispatcher.utter_message("HEllo its me the action server")

        return []

# class ActionSaveSlotsInDict(Action):

#     def name(self) -> Text:
#         return "action_save_slots_in_dict"
...
#         # Here you can return an empty list or events if needed
#         return []
